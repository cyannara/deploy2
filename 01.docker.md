...
Eclipse Temurin(이클립스 테무린)은 Adoptium(구 AdoptOpenJDK) 프로젝트에서 관리하는 고품질의 오픈 소스 자바(Java) 런타임 환경(OpenJDK)입니다. TCK 인증을 통과한 신뢰할 수 있는 무료 JDK로, 널리 사용되는 사실상의 표준 OpenJDK 빌드입니다  
